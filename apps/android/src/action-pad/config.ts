...
const UP_NAVIGATION_MENU = {
  ...
  rows: [
    [
      ...
      { id: 'five-lines-up', label: '+5 Lines', type: 'input', nvimInput: '5k' },
      { id: 'ten-lines-up', label: '+10 Lines', type: 'input', nvimInput: '10k' },
      { id: 'screen-top', label: 'H Screen Top', type: 'input', nvimInput: 'H' }
    ],
    [
      { id: 'half-page-up', label: 'Half Page Up', type: 'input', nvimInput: '<C-u>' },
      { id: 'full-page-up', label: 'Full Page Up', type: 'input', nvimInput: '<C-b>' }
    ]
  ]
...
const DOWN_NAVIGATION_MENU = {
  ...
  rows: [
    [
      ...
      { id: 'five-lines-down', label: '+5 Lines', type: 'input', nvimInput: '5j' },
      { id: 'ten-lines-down', label: '+10 Lines', type: 'input', nvimInput: '10j' },
      { id: 'screen-bottom', label: 'L Screen Bot', type: 'input', nvimInput: 'L' }
    ],
    [
      { id: 'half-page-down', label: 'Half Page Down', type: 'input', nvimInput: '<C-d>' },
      { id: 'full-page-down', label: 'Full Page Down', type: 'input', nvimInput: '<C-f>' }
    ]
  ]
} as const satisfies ActionMenu
...
const SEARCH_MENU = {
  ...
  rows: [
    [
      { id: 'grep', label: 'Grep (Live)', type: 'input', nvimInput: '<Space>sg' },
      { id: 'files', label: 'Find File', type: 'input', nvimInput: '<Space>sf' },
      { id: 'buffer', label: 'Buffer Search', type: 'input', nvimInput: '<Space>/' },
      { id: 'symbols', label: 'Symbol', type: 'input', nvimInput: 'gO' },
      { id: 'recent', label: 'Recent Files', type: 'input', nvimInput: '<Space>s.' }
    ],
    [
      { id: 'replace', label: 'Replace', type: 'input', nvimInput: ':%s/' },
      { id: 'word', label: 'Word Under Cursor', type: 'input', nvimInput: '<Space>sw' },
      { id: 'diagnostics', label: 'Diagnostics', type: 'input', nvimInput: '<Space>sd' }
    ]
  ]
} as const satisfies ActionMenu
...
const WINDOW_MENU = {
  ...
  rows: [
    ...
    [
      { id: 'vertical-split', label: 'V Split', type: 'input', nvimInput: '<C-w>v' },
...
const CODE_MENU = {
  ...
  rows: [
    [
      { id: 'definition', label: 'Definition', type: 'input', nvimInput: 'grd' },
      { id: 'references', label: 'References', type: 'input', nvimInput: 'grr' },
      { id: 'implementation', label: 'Implementation', type: 'input', nvimInput: 'gri' },
      { id: 'type-definition', label: 'Type', type: 'input', nvimInput: 'grt' },
      { id: 'hover', label: 'Hover', type: 'input', nvimInput: 'K' }
    ],
    [
      { id: 'code-action', label: 'Code Action', type: 'input', nvimInput: 'gra' },
      { id: 'rename', label: 'Rename', type: 'input', nvimInput: 'grn' },
      { id: 'format', label: 'Format', type: 'input', nvimInput: '<Space>f' },
      { id: 'diagnostic', label: 'Diagnostic', type: 'input', nvimInput: '<C-w>d' }
    ]
  ]
} as const satisfies ActionMenu
...
const LEADER_MENU = {
  ...
  rows: [
    [
      ...
      { id: 'buffers', label: 'Buffers', type: 'input', nvimInput: '<Space><Space>' },
      { id: 'window', label: 'Window', type: 'menu', menu: WINDOW_MENU },
      { id: 'code', label: 'Code', type: 'menu', menu: CODE_MENU }
    ],
    [
      { id: 'project-tree', label: 'Project Tree', type: 'input', nvimInput: '<Space>e' },
      { id: 'outline', label: 'Outline', type: 'input', nvimInput: '<Space>o' },
      { id: 'terminal', label: 'Terminal', type: 'input', nvimInput: ':terminal<CR>' },
...
const COMMAND_MENU = {
  ...
  rows: [
    [
      ...
      { id: 'save-all', label: 'Save All', type: 'input', nvimInput: ':wa<CR>' },
      { id: 'quit', label: 'Quit', type: 'input', nvimInput: ':q<CR>' },
      { id: 'force-quit', label: 'Force Quit', type: 'input', nvimInput: ':q!<CR>' },
      { id: 'write-quit', label: 'Write and Quit', type: 'input', nvimInput: ':wq<CR>' }
    ],
    [
...
export const ACTION_PAD_MENU = {
  ...
  rows: [
    ...
    [
      { id: 'left', label: '←', accessibilityLabel: 'Left', type: 'key', key: 'ArrowLeft' },
      {
        id: 'down',
        label: '↓',
      ...
      { id: 'right', label: '→', accessibilityLabel: 'Right', type: 'key', key: 'ArrowRight' },
